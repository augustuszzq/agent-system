...
`job list` prints the local registry view of draft and scheduler-derived jobs. `job render-pbs` prints the rendered PBS script only; it does not submit anything. Real submission remains a Phase 3B task.
